...
export const Hero = () => {
  return (
    ...
    lg:text-6xl font-semibold tracking-wider mt-4'>
        Order FOR
        <br />
        Something NEW
    </h1>
    ...
    THERE IS THE BEST WAY TO ORDER THE BEST COFFEES 
    THAT ARE CHEAP AND HAVE THE BEST QUALITY, 
    INSTEAD OF CHOOSING ANOTHER PLACES 
    AND SHOPES TO ORDER COFFEES THAT ARE EXPENSIVE 
    AND DON'T HAVE BEST QUALITY, YOU CAN HOPEFULLY DECIDE 
    ABOUT THIS......
    </p>

    <div className='flex gap-4 mt-12 '>
        <a className='border border-[#2a2a2a] py-2 sm:py-3
         px-4 sm:px-5 rounded-full sm:text-lg text-sm 
         font-semibold tracking-wider transition-all 
         duration-300 hover:bg-[#1a1a1a]' href="#">
            MENU <i class='bx bx-link-external'></i>
        </a>
       <a className='border border-[#2a2a2a] py-2 sm:py-3
         px-8 sm:px-10 rounded-full sm:text-lg text-sm 
         font-semibold tracking-wider transition-all 
         duration-300 hover:bg-[#1a1a1a] bg-gray-300 
         text-black hover:text-white' href="#">
            About Sata <i class='bx bx-link-external'></i>
        </a>
    </div>
